...
int main(){
   ...
   c:	7b850513          	addi	a0,a0,1976 # 7c0 <malloc+0xe6>
  10:	00000097          	auipc	ra,0x0
  14:	612080e7          	jalr	1554(ra) # 622 <printf>
	return 0;
}
  18:	4501                	li	a0,0
  1a:	60a2                	ld	ra,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 390:	4a450513          	addi	a0,a0,1188 # 830 <digits>
 394:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 450:	38cc8c93          	addi	s9,s9,908 # 7d8 <malloc+0xfe>
 ...
 45e:	3d6b8b93          	addi	s7,s7,982 # 830 <digits>
 ...
 584:	25098993          	addi	s3,s3,592 # 7d0 <malloc+0xf6>
        while(*s != 0){
 588:	85ee                	mv	a1,s11
