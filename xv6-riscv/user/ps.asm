...
int main(){
  ...
  1a:	648080e7          	jalr	1608(ra) # 65e <printf>
	for(p = proc; p < &proc[NPROC]; p++)
  1e:	00001497          	auipc	s1,0x1
  22:	14a48493          	addi	s1,s1,330 # 1168 <proc+0x158>
  26:	00007997          	auipc	s3,0x7
  2a:	b4298993          	addi	s3,s3,-1214 # 6b68 <base+0x158>
		//if(p->state == RUNNING)
			printf("%d\t\t%s\n", p->pid, p->name);		
  2e:	00000917          	auipc	s2,0x0
  32:	7e290913          	addi	s2,s2,2018 # 810 <malloc+0xfa>
  36:	8626                	mv	a2,s1
  38:	ed84a583          	lw	a1,-296(s1)
  3c:	854a                	mv	a0,s2
  3e:	00000097          	auipc	ra,0x0
  42:	620080e7          	jalr	1568(ra) # 65e <printf>
	for(p = proc; p < &proc[NPROC]; p++)
  46:	16848493          	addi	s1,s1,360
  4a:	ff3496e3          	bne	s1,s3,36 <main+0x36>
	return 0;
}
  4e:	4501                	li	a0,0
  50:	70a2                	ld	ra,40(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cc:	4b050513          	addi	a0,a0,1200 # 878 <digits>
 3d0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48c:	398c8c93          	addi	s9,s9,920 # 820 <malloc+0x10a>
 ...
 49a:	3e2b8b93          	addi	s7,s7,994 # 878 <digits>
 ...
 5c0:	25c98993          	addi	s3,s3,604 # 818 <malloc+0x102>
        while(*s != 0){
 5c4:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 76c:	a895                	j	7e0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 76e:	00006797          	auipc	a5,0x6
 772:	2a278793          	addi	a5,a5,674 # 6a10 <base>
